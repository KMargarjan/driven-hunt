...
|---|---|---|---|
| Source delivery, not a runtime owner (every script container: ServerScriptService, ReplicatedStorage, ReplicatedFirst, StarterGui, StarterPack, StarterPlayerScripts, StarterCharacterScripts, ServerStorage.Tests) | Rojo, from the files on disk. Runtime systems inside these containers get their own rows | `default.project.json` | [toolchain](docs/research/2026-09-24-toolchain.md) |
